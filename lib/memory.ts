...
export class MemoryManager {
    ...
    public async vectorSearch(recentChatHistory: string, companionFileName: string) {
        ...
        const vectorStore = await PineconeStore.fromExistingIndex(
            new OpenAIEmbeddings({ openAIApiKey: process.env.OPEN_AI_KEY }), { pineconeIndex }
        );
    ...
    public async writeToHistory(text: string, companionKey: CompanionKey) {
        this.checkCompanionKey(companionKey);
    ...
    private checkCompanionKey(companionKey: CompanionKey) {
